...
* [Sierra MARC cataloguing](current-system-guidelines/sierra-marc-cataloguing/README.md)
  ...
  * [Format Examples](current-system-guidelines/format-examples/format-examples.md)
    * [Album](current-system-guidelines/format-examples/format-examples/album.md)
    * [Drawing](current-system-guidelines/format-examples/format-examples/drawing.md)
    * [Painting](current-system-guidelines/format-examples/format-examples/painting.md)
    * [Photograph](current-system-guidelines/format-examples/format-examples/photograph.md)
    * [Poster](current-system-guidelines/format-examples/format-examples/poster.md)
    * [Print](current-system-guidelines/format-examples/format-examples/print.md)
